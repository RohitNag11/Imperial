...
class Engine:
    ...
    def __get_score(self):
        ...
        # TODO
        score = 0
        # Award points for low engine diameter:
        score += act.smooth_step_down(self.diameter,
                                      start=2,
                                      end=3.5,
                                      min_y=0,
                                      max_y=10)
